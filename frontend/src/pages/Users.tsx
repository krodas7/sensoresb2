...
const Users: React.FC = () => {
  ...
  // Cargar usuarios desde localStorage o usar datos mock
  useEffect(() => {
    const savedUsers = localStorage.getItem('beneficio_users')
    if (savedUsers) {
      setUsers(JSON.parse(savedUsers))
    } else {
      setUsers(initialUsers)
      localStorage.setItem('beneficio_users', JSON.stringify(initialUsers))
    }
  }, [])
  ...
  const handleSaveUser = () => {
    ...
    localStorage.setItem('beneficio_users', JSON.stringify(updatedUsers))
