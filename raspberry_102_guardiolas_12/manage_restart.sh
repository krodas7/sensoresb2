...
# Script para gestionar el reinicio programado del servicio de guardiolas 1-2
...
show_help() {
    echo -e "${BLUE}=== Gestor de Reinicio Programado - API Beneficio (Guardiolas 1-2) ===${NC}"
    echo ""
    echo "Uso: $0 [comando]"
    echo ""
...
show_status() {
    echo -e "${BLUE}=== Estado del Sistema de Guardiolas 1-2 ===${NC}"
    echo ""
