#!/usr/bin/env python3
"""
Script de integración para sensores reales de temperatura
Reemplaza la función simulate_sensor_reading() con tu código real del sensor.

Ejemplo para sensor DS18B20:
"""
...
# Configuración
SERVER_URL = "http://192.168.0.21:8000/api/v1/sensors/data/"  # IP del servidor Django
