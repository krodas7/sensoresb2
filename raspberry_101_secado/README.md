...
## 📋 Información General
- **IP**: 192.168.0.101
- **Función**: Monitoreo de 3 Sensores (Horno + Pila 5 + Pila 6)
...
### Conexiones Individuales por Sensor (7 Sensores)
...
### Prueba de Sensores
```bash
# Ejecutar script de prueba de 7 sensores
cd /home/laptop/secado
python3 test_7_sensores_final.py

# Ejecutar script simple (3 sensores de prueba)
python3 test_sensores_simple.py

# Verificar lectura individual del Horno
python3 -c "
...
# Probar API
curl -u laptop:beneficiob2 http://192.168.0.150:8000/api/temperatura/resumen/
```
...
```bash
# Verificar todos los 7 sensores
python3 test_7_sensores_final.py
...
# Probar los 7 sensores configurados
sensors = {
    'Horno': 14, 'Pila 1': 5, 'Pila 2': 6, 'Pila 3': 13,
    'Pila 4': 16, 'Pila 5': 23, 'Pila 6': 25
}
...
- **7 sensores** en lugar de 9 (Horno + Pilas 1-6)
...
### Pines Seleccionados
- **GPIO 5, 6, 13, 16, 23, 25**: Pines recomendados para CS
- **GPIO 14**: Horno (ya funcionaba bien)
...
- `test_7_sensores_final.py` - Prueba de los 7 sensores de producción
- `test_sensores_simple.py` - Prueba simple (3 sensores)
