...
# Script para gestionar el reinicio programado del servicio de guardiolas 3-4
# API Beneficio - Sistema de monitoreo automático

SERVICE_NAME="guardiolas-34-sensor-client"
TIMER_NAME="guardiolas-34-restart.timer"
RESTART_SERVICE_NAME="guardiolas-34-restart.service"
...
show_help() {
    echo -e "${BLUE}=== Gestor de Reinicio Programado - API Beneficio (Guardiolas 3-4) ===${NC}"
    echo ""
    echo "Uso: $0 [comando]"
    echo ""
...
show_status() {
    echo -e "${BLUE}=== Estado del Sistema de Guardiolas 3-4 ===${NC}"
    echo ""
